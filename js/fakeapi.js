...
function addElement(appendIn, value){
    ...
    div.innerHTML = `
            ...
            <div class="text-center py-3 font-poppins">
                ...
                <a href="productpage.html"  class="buyNowButton" data-id="${id}"> Buy Now </a></button>
            </div>
    `;
    appendIn.appendChild(div);
    let button = div.querySelector(".buyNowButton");
    button.addEventListener("click",buyNowFunc)
}

function buyNowFunc(){
    const button = this;
    localStorage.setItem("product_id",button.dataset.id);
}